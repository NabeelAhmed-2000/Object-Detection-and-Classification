...
1. **Non-real-time Object Detection in a sample image**
   - Sample input image
     ...
     - To test with your own image, modify the code in 'In [7]' of file [source_code_image.ipynb](/source_code_image.ipynb) as shown below:\
       ...
       [Line 88](https://github.com/NabeelAhmed-2000/Object-Detection-and-Classification/blob/8d9a12df83eafc157ffe6439795b9ad4f438e174/source_code_image.ipynb?plain=1#L88)
